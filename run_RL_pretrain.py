...
parser.add_argument('--data_pretrain',       type=str, default='ETTm1')
parser.add_argument('--data_path_pretrain',  type=str, default='ETTh1.csv')
parser.add_argument('--data_test',       type=str, default='ETTm1')
parser.add_argument('--data_path_test',  type=str, default='ETTh1.csv')
...
val_data,   val_loader   = data_provider(args, args.data_pretrain, args.data_path_pretrain, True,  'val')
# 使用 B（data_test）做最终测试评估
test_data,  test_loader  = data_provider(args, args.data_test,    args.data_path_test,    False, 'test')
...
for epoch in range(args.train_epochs):
    ...
    if accelerator.is_local_main_process:
        ...
        csv_filename = f"result_rl_{args.model}_zeroshot.csv"
